  ...
  return (
    <Layout>
      ...
      <PrivateRoutes {...props} path="/admin_matches" exact component={AdminMatches}/>
        ...
        <PublicRoutes {...props} retricted={false} path="/" exact component={Home}/>
        <PublicRoutes {...props} retricted={true} path="/sign_in" exact component={SignIn}/>
        <PublicRoutes {...props} retricted={false} path="/the_team" exact component={Theteam}/>
        <PublicRoutes {...props} retricted={false} path="/the_matches" exact component={TheMatches}/>
